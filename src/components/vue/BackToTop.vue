...
<template>
  <div
    class=":uno: fixed border border-navigation-border bottom-8 right-8 z-10 grid place-items-center p-1 shadow bg-navigation-background transition-colors text-content rounded-md shadow-md hidden md:block"
  >

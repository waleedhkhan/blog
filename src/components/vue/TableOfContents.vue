...
<template>
  <div
    class=":uno: border border-navigation-border bottom-8 left-8 z-10 grid place-items-center p-1 md:p-0 md:border-none shadow md:shadow-none md:bg-transparent bg-navigation-background md:top-32 md:bottom-unset transition-colors text-content rounded-md shadow-md fixed hidden md:grid"
  >
...
div[data-radix-popper-content-wrapper]:has(
    .toc__container[data-state="closed"]
  ) {
  pointer-events: none;
  visibility: hidden;
}

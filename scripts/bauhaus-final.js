...
// Core categories following Bauhaus principles
const CATEGORIES = {
  design: {
    patterns: [
      /design/i,
...
// Extract metadata with Bauhaus minimalism
...
function determineCategory(url, title, content) {
  ...
  // Default to design for uncategorized items
  return 'design';
}
...
async function main() {
  try {
    console.log('Starting final Bauhaus cleanup...');
